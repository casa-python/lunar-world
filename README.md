...
-   **사용자 경험(UX) 중심의 반복적 개발**: 초기 버전의 불편한 점을 파악하고, 미니맵 추가, 시점 변경, UI 개선 등 사용자 경험을 향상시키기 위한 반복적인 개발 과정을 통해 더 나은 결과물을 만들 수 있었습니다.
-   **다양한 기술의 융합**: 위치 기반 서비스, 증강현실, 3D 그래픽 등 여러 기술을 하나의 프로젝트에 성공적으로 융합하는 경험을 했습니다.
